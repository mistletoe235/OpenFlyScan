...
All five source repositories and the Expo East HF package are public.
...
The Expo East runtime and its license/source attachments are publicly available
on HF; see [download and setup](simulator.md).
